...
plt.tight_layout()
plt.savefig("Group4_data_analysis/data/plot_heatmap_hora_mes.png")
...
plt.ylabel("Velocidad del viento (m/s)")
plt.tight_layout()
plt.savefig("Group4_data_analysis/data/plot_media_movil_30dias.png")
...
plt.ylabel("Velocidad del viento (m/s)")
plt.tight_layout()
plt.savefig("figures/plot_linea_evolucion.png")
print("✅ Gráfico de líneas guardado.")
...
plt.ylabel("Frecuencia")
plt.tight_layout()
plt.savefig("figures/plot_histograma_distribucion.png")
print("✅ Histograma guardado.")
...
plt.ylabel("Velocidad del viento (m/s)")
plt.tight_layout()
plt.savefig("figures/plot_boxplot_mensual.png")
print("✅ Boxplot mensual guardado.")
...
plt.ylabel("Velocidad del viento (m/s)")
plt.tight_layout()
plt.savefig("figures/plot_violin_mensual.png")
print("✅ Violin plot mensual guardado.")
...
plt.grid(True, linestyle="--", alpha=0.4)
plt.tight_layout()
plt.savefig("figures/plot_media_mensual_evolucion_mejorado.png")
print("✅ Media mensual del viento (mejorada) guardada.")
...
plt.ylabel("Hora del día")
plt.tight_layout()
plt.savefig("figures/plot_heatmap_hora_mes.png")
print("✅ Heatmap hora-mes guardado.")
...
plt.ylabel("Velocidad del viento (m/s)")
plt.tight_layout()
plt.savefig("figures/plot_media_movil_30dias.png")
print("✅ Gráfico de media móvil guardado.")
